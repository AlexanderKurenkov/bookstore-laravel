 ...
 *
 * Отвечает за обработку пользовательских заказов: отмену, получение доставленных заказов,
 * управление возвратами книг, а также предоставление информации о возвратах.
 * Обеспечивает контроль доступа и корректную бизнес-логику операций, связанных с заказами.
 */
class OrderService
{
    /**
