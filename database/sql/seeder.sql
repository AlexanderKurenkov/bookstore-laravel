...
VALUES
    ...
    ('Мастер и Маргарита', 'Михаил Булгаков', 'Эксмо', '/images/books/2.webp',
    ...
    ('Герой нашего времени', 'Михаил Лермонтов', 'Азбука', '/images/books/10.webp',
...
INSERT INTO categories (name, url_slug, description) VALUES
	('Фантастика', 'fiction', 'Книги о вымышленных мирах и технологиях будущего'),
    ('Детектив', 'detective', 'Истории о расследованиях преступлений'),
    ('Фэнтези', 'Fantasy', 'Мир магии, волшебства и невероятных приключений'),
    ('История', 'history', 'Книги о прошлом, исторических событиях и личностях'),
    ('Биография',  'biography', 'Жизнеописания известных людей'),
	('Наука', 'science', 'Книги о научных открытиях и исследованиях'),
    ('Философия', 'philosophy', 'Размышления о жизни, бытии и сознании'),
    ('Психология', 'psychology', 'Книги о человеческом мышлении и поведении'),
    ('Классика', 'classics', 'Произведения, проверенные временем'),
    ('Поэзия', 'poetry', 'Сборники стихотворений и поэм'),
    ('Все книги', 'all', 'Все книги в каталоге');
