...
@php
    // Get book rating
    // $bookRating = $catalogService->getBookRating($book->id);
    $bookRating = 0;
      ...
      <div class="col-md-7">
          <div class="card h-100">
              <div class="card-body">
                  ...
                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Название:</div>
                      <div class="col-md-7">{{ $book->title }}</div>
                  </div>

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Автор:</div>
                      <div class="col-md-7">{{ $book->author }}</div>
                  </div>

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Издательство:</div>
                      <div class="col-md-7">{{ $book->publisher }}</div>
                  </div>

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Год издания:</div>
                      <div class="col-md-7">{{ $book->publication_year }}</div>
                  </div>

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">ISBN:</div>
                      <div class="col-md-7">{{ $book->isbn }}</div>
                  </div>

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Язык:</div>
                      <div class="col-md-7">{{ $book->language }}</div>
                  </div>

                  @if($book->edition)
                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Издание:</div>
                      <div class="col-md-7">{{ $book->edition }}</div>
                  </div>
                  @endif

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Тип издания:</div>
                      <div class="col-md-7">
                  ...
                  @if($book->publication_type == 'physical')
                      ...
                      <div class="row mb-2">
                          <div class="col-md-5 fw-bold">Тип переплета:</div>
                          <div class="col-md-7">
                      ...
                      @if($book->pages)
                      <div class="row mb-2">
                          <div class="col-md-5 fw-bold">Количество страниц:</div>
                          <div class="col-md-7">{{ $book->pages }}</div>
                      </div>
                      @endif

                      @if($book->weight)
                      <div class="row mb-2">
                          <div class="col-md-5 fw-bold">Вес:</div>
                          <div class="col-md-7">{{ $book->weight }} г</div>
                      </div>
                      @endif
                  @endif

                  <div class="row mb-2">
                      <div class="col-md-5 fw-bold">Наличие:</div>
                      <div class="col-md-7">
                          @if($book->publication_type == 'physical')
                  ...
                  <div class="row mb-4">
                      <div class="col-md-5 fw-bold">Цена:</div>
                      <div class="col-md-7">
                  ...
                  <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4">
                      ...
                      @else
                          @if(session()->has('cart') && in_array($book->id, session('cart')))
                              <a href="{{ route('checkout.index') }}" class="btn btn-success" type="button">
                                  <i class="bi bi-bag-check"></i> Оформить
                              </a>
                          @else
                              <button id="addToCartBtn{{ $book->id }}" onclick="addToCartButtonClicked({{ $book->id }})" class="btn btn-outline-primary" type="button" data-href="{{ route('checkout.index') }}">
                  ...
                  <div class="card mb-3">
                      <div class="card-body">
                          <div class="d-flex justify-content-between mb-2">
                              <h5 class="card-title">
                                  <i class="bi bi-person-circle me-2"></i>{{ $review->user->name }}
                              </h5>
...
window.addToCartButtonClicked = function(id) {
