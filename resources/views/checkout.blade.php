<x-layout>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <!-- In the contact information section, pre-fill with authenticated user data -->
                                    <div class="col-md-6">
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <!-- In the address section, pre-fill with authenticated user's address if available -->
                                    <div class="col-12">
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check mb-3 p-0">
                                            <!-- Fix alignment in delivery method section -->
                                            <div class="card mb-2 delivery-option">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center">
                                                        <input class="form-check-input mt-0 me-3" type="radio" name="delivery_method"
                                            ...
                                            <div class="card delivery-option">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <label class="form-check-label w-100" for="delivery_pickup">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                        ...
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-check mb-3 p-0">
                                            <!-- Fix alignment in payment method section and add icons -->
                                            <div class="card mb-2 payment-option">
                                                <div class="card-body p-3">
                                                    <div class="d-flex align-items-center">
                                                        <input class="form-check-input mt-0 me-3" type="radio" name="payment_method"
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="small mb-0"><i class="bi bi-envelope me-2"></i>support@knigochei.site</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    .delivery-option input:checked + label, .payment-option input:checked + label {
      font-weight: 500;
    }

    .delivery-option input:checked + label .card-body, .payment-option input:checked + label .card-body {
